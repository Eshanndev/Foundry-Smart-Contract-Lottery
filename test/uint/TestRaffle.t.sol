...
contract TestRaffle is Test, CodeConstants {
    ...
    function testRaffle_perfromUpKeepRevertIfUpKeeNeededIsFalse() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(Raffle.Raffle__upkeepNotNeeded.selector, playersLength, contractBalance, raffleState)
        );
    ...
    function testRaffle_fullfillRandomWordsOnlyCanBeCalledAfterPerformUpKeep(uint256 randomNumber)
        public
        usersEnteredAndIntervalPassed
        skipOnForkTest /*either way this is going to fail if test on a fork because of a evm error*/
    {
    ...
    function testRaffle_fullfillRandomWordsPicksAWinnerAndPayThem()
        public
        usersEnteredAndIntervalPassed
        skipOnForkTest
    {
